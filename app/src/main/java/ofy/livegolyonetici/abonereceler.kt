...
class abonereceler(val Aboneler:ArrayList<abonedata>, val Contex: Context,val itemClickListener: (View, Int, Int) -> Unit) : androidx.recyclerview.widget.RecyclerView.Adapter<abonereceler.macviewholder>() {
